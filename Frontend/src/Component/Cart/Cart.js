  ...
  return (
    <>
      <div className='login-main' style={{ "display": `${loader ? "none" : "block"}` }}>
        <img onLoad={()=>Setloader(false)} className='login-img' src='https://images.pexels.com/photos/3184193/pexels-photo-3184193.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2' alt='' />
